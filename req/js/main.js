...
(function () {
  ...
  /* ── Hero canvas — the real sky over Bengaluru, live ─────────
   * A south-facing panorama of the night sky at 12.9716°N,
   * 77.5946°E (the coordinates on the id card), computed from
  ...
  if (canvas && canvas.getContext) {
    ...
    var ox = 0, oy = 0;
    var RAD = Math.PI / 180, LAT = 12.9716 * RAD, LON = 77.5946;
    ...
    /* Equatorial → horizontal for Bengaluru, now; south-centred
